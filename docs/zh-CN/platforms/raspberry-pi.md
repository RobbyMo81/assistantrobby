...
| Pi 型号         | 内存    | 是否可用？  | 说明                       |
| --------------- | ------- | ----------- | -------------------------- |
| **Pi 5**        | 4GB/8GB | [OK] 最佳   | 最快，推荐                 |
| **Pi 4**        | 4GB     | [OK] 良好   | 大多数用户的最佳选择       |
| **Pi 4**        | 2GB     | [OK] 可以   | 可用，添加交换空间         |
| **Pi 4**        | 1GB     | [WARN] 紧张 | 使用交换空间可行，最小配置 |
| **Pi 3B+**      | 1GB     | [WARN] 慢   | 可用但较慢                 |
| **Pi Zero 2 W** | 512MB   | [FAIL]      | 不推荐                     |
...
| ------------------ | ---------- | ----------------------------------- |
| Node.js            | [OK]       | 运行良好                            |
| WhatsApp (Baileys) | [OK]       | 纯 JS，无问题                       |
| Telegram           | [OK]       | 纯 JS，无问题                       |
| gog (Gmail CLI)    | [WARN]     | 检查是否有 ARM 版本                 |
